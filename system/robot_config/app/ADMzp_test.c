...
int MainModule()
{
	...
	double M[6]={10,10,10,10,10,1};
        ...
        double K[6]={50,50,0,10000,10000,2};
	...
	robpose robpose_rot1=Offs(p21,0,0,0,0,0,0.3);
	robpose robpose_rot2=Offs(p21,0,0,0,0,0,-0.3);
        while (robot_ok())
	{
		...
		moveL(&robpose_rot1,v10,z0,tool10,wobj0);
		moveL(&robpose_rot2,v10,z0,tool10,wobj0);
	}
	//Rsleep(1000);
