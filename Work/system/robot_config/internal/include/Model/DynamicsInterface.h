...
/*-------------------------------------------------------------------------*/
typedef struct {
	double q[ROBOT_MAX_DOF];/**< 关节位置(rad 或 m)*/
	double qd[ROBOT_MAX_DOF];/**< 关节速度(rad/s 或 m/s)*/
	double qdd[ROBOT_MAX_DOF];/**< 关节加速度(rad/s^2 或 m/s^2)*/
	double fext[6];/**< 外部力*/
	int fcv_flag;/**< 是否使用摩擦力标识，0:不使用，1:使用*/
	int g_flag;/**< 是否使用重力标识，0:不使用，1:使用*/
	double torque[ROBOT_MAX_DOF];/**< 关节力矩(Nm 或 N)*/
	double torque_1[ROBOT_MAX_DOF];/**< 前一时刻关节力矩(Nm 或 N)*/
	int dof;/**< 机器人自由度*/
	PayLoad payload;/**< 负载*/
 ...
 *
 * @param _rdyn 动力学数据
 * @param q 关节位置(rad 或 m)
 * @param qd 关节速度(rad/s 或 m/s)
 * @param qdd 关节加速度(rad/s^2 或 m/s^2)
 * @param torque 关节力矩(Nm 或 N)
 * @param fext 外部力
 ...
 *
 * @param _rdyn 动力学数据
 * @param q 返回关节位置(rad 或 m)
 * @param qd 返回关节速度(rad/s 或 m/s)
 * @param qdd 返回关节加速度(rad/s^2 或 m/s^2)
 */
